    ...
    <section id="about" className="sanctuary-section" aria-labelledby="sanctuary-heading">
      ...
      <div className="sanctuary-feather" aria-hidden>
        <svg viewBox="0 0 100 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M50 190 C 50 190, 48 100, 50 20 C 52 100, 50 190, 50 190 Z" stroke="#1D5C96" strokeWidth="0.5"/>
          <path d="M50 20 C 30 40, 20 80, 50 120 C 80 80, 70 40, 50 20 Z" stroke="#0D7C72" strokeWidth="0.5" fill="rgba(13, 124, 114, 0.1)"/>
          <circle cx="50" cy="55" r="8" stroke="#1D5C96" strokeWidth="0.5" fill="rgba(10, 74, 122, 0.5)"/>
          <circle cx="50" cy="55" r="4" fill="#041F38"/>
          <path d="M50 40 Q 35 30 25 50" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 45 Q 30 40 20 60" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 50 Q 25 50 15 70" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 60 Q 30 70 25 90" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 70 Q 35 85 30 105" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 40 Q 65 30 75 50" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 45 Q 70 40 80 60" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 50 Q 75 50 85 70" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 60 Q 70 70 75 90" stroke="#1D5C96" strokeWidth="0.3"/>
          <path d="M50 70 Q 65 85 70 105" stroke="#1D5C96" strokeWidth="0.3"/>
        </svg>
      </div>
          ...
          <div className="sanctuary-eyebrow-wrap">
            ...
            <div className="sanctuary-eyebrow-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2C12 2 9 8 12 12C15 8 12 2 12 2Z" fill="#1D5C96"/>
                <path d="M12 22C12 22 9 16 12 12C15 16 12 22 12 22Z" fill="#1D5C96"/>
                <path d="M2 12C2 12 8 9 12 12C8 15 2 12 2 12Z" fill="#1D5C96"/>
                <path d="M22 12C22 12 16 9 12 12C16 15 22 12 22 12Z" fill="#1D5C96"/>
                <circle cx="12" cy="12" r="2" fill="#1D5C96"/>
              </svg>
            </div>
          </div>
